...
all_requirements = ["@everest-testing_pip_deps//attrs:pkg", "@everest-testing_pip_deps//cffi:pkg", "@everest-testing_pip_deps//cryptography:pkg", "@everest-testing_pip_deps//exceptiongroup:pkg", "@everest-testing_pip_deps//importlib_resources:pkg", "@everest-testing_pip_deps//iniconfig:pkg", "@everest-testing_pip_deps//jinja2:pkg", "@everest-testing_pip_deps//jsonschema:pkg", "@everest-testing_pip_deps//jsonschema_specifications:pkg", "@everest-testing_pip_deps//markupsafe:pkg", "@everest-testing_pip_deps//ocpp:pkg", "@everest-testing_pip_deps//packaging:pkg", "@everest-testing_pip_deps//paho_mqtt:pkg", "@everest-testing_pip_deps//pkgutil_resolve_name:pkg", "@everest-testing_pip_deps//pluggy:pkg", "@everest-testing_pip_deps//pycparser:pkg", "@everest-testing_pip_deps//pyftpdlib:pkg", "@everest-testing_pip_deps//pyopenssl:pkg", "@everest-testing_pip_deps//pyrsistent:pkg", "@everest-testing_pip_deps//pytest:pkg", "@everest-testing_pip_deps//pytest_asyncio:pkg", "@everest-testing_pip_deps//python_dateutil:pkg", "@everest-testing_pip_deps//pyyaml:pkg", "@everest-testing_pip_deps//referencing:pkg", "@everest-testing_pip_deps//rpds_py:pkg", "@everest-testing_pip_deps//six:pkg", "@everest-testing_pip_deps//stringcase:pkg", "@everest-testing_pip_deps//tomli:pkg", "@everest-testing_pip_deps//websockets:pkg", "@everest-testing_pip_deps//zipp:pkg"]
