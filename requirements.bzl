...
all_requirements = ["@everest-testing_pip_deps//attrs:pkg", "@everest-testing_pip_deps//cffi:pkg", "@everest-testing_pip_deps//cryptography:pkg", "@everest-testing_pip_deps//exceptiongroup:pkg", "@everest-testing_pip_deps//iniconfig:pkg", "@everest-testing_pip_deps//jinja2:pkg", "@everest-testing_pip_deps//jsonschema:pkg", "@everest-testing_pip_deps//jsonschema_specifications:pkg", "@everest-testing_pip_deps//markupsafe:pkg", "@everest-testing_pip_deps//ocpp:pkg", "@everest-testing_pip_deps//packaging:pkg", "@everest-testing_pip_deps//paho_mqtt:pkg", "@everest-testing_pip_deps//pluggy:pkg", "@everest-testing_pip_deps//pycparser:pkg", "@everest-testing_pip_deps//pyftpdlib:pkg", "@everest-testing_pip_deps//pyopenssl:pkg", "@everest-testing_pip_deps//pyrsistent:pkg", "@everest-testing_pip_deps//pytest:pkg", "@everest-testing_pip_deps//pytest_asyncio:pkg", "@everest-testing_pip_deps//python_dateutil:pkg", "@everest-testing_pip_deps//pyyaml:pkg", "@everest-testing_pip_deps//referencing:pkg", "@everest-testing_pip_deps//rpds_py:pkg", "@everest-testing_pip_deps//six:pkg", "@everest-testing_pip_deps//stringcase:pkg", "@everest-testing_pip_deps//tomli:pkg", "@everest-testing_pip_deps//websockets:pkg"]

all_whl_requirements_by_package = {"attrs": "@everest-testing_pip_deps//attrs:whl", "cffi": "@everest-testing_pip_deps//cffi:whl", "cryptography": "@everest-testing_pip_deps//cryptography:whl", "exceptiongroup": "@everest-testing_pip_deps//exceptiongroup:whl", "iniconfig": "@everest-testing_pip_deps//iniconfig:whl", "jinja2": "@everest-testing_pip_deps//jinja2:whl", "jsonschema": "@everest-testing_pip_deps//jsonschema:whl", "jsonschema_specifications": "@everest-testing_pip_deps//jsonschema_specifications:whl", "markupsafe": "@everest-testing_pip_deps//markupsafe:whl", "ocpp": "@everest-testing_pip_deps//ocpp:whl", "packaging": "@everest-testing_pip_deps//packaging:whl", "paho_mqtt": "@everest-testing_pip_deps//paho_mqtt:whl", "pluggy": "@everest-testing_pip_deps//pluggy:whl", "pycparser": "@everest-testing_pip_deps//pycparser:whl", "pyftpdlib": "@everest-testing_pip_deps//pyftpdlib:whl", "pyopenssl": "@everest-testing_pip_deps//pyopenssl:whl", "pyrsistent": "@everest-testing_pip_deps//pyrsistent:whl", "pytest": "@everest-testing_pip_deps//pytest:whl", "pytest_asyncio": "@everest-testing_pip_deps//pytest_asyncio:whl", "python_dateutil": "@everest-testing_pip_deps//python_dateutil:whl", "pyyaml": "@everest-testing_pip_deps//pyyaml:whl", "referencing": "@everest-testing_pip_deps//referencing:whl", "rpds_py": "@everest-testing_pip_deps//rpds_py:whl", "six": "@everest-testing_pip_deps//six:whl", "stringcase": "@everest-testing_pip_deps//stringcase:whl", "tomli": "@everest-testing_pip_deps//tomli:whl", "websockets": "@everest-testing_pip_deps//websockets:whl"}

all_whl_requirements = all_whl_requirements_by_package.values()

all_data_requirements = ["@everest-testing_pip_deps//attrs:data", "@everest-testing_pip_deps//cffi:data", "@everest-testing_pip_deps//cryptography:data", "@everest-testing_pip_deps//exceptiongroup:data", "@everest-testing_pip_deps//iniconfig:data", "@everest-testing_pip_deps//jinja2:data", "@everest-testing_pip_deps//jsonschema:data", "@everest-testing_pip_deps//jsonschema_specifications:data", "@everest-testing_pip_deps//markupsafe:data", "@everest-testing_pip_deps//ocpp:data", "@everest-testing_pip_deps//packaging:data", "@everest-testing_pip_deps//paho_mqtt:data", "@everest-testing_pip_deps//pluggy:data", "@everest-testing_pip_deps//pycparser:data", "@everest-testing_pip_deps//pyftpdlib:data", "@everest-testing_pip_deps//pyopenssl:data", "@everest-testing_pip_deps//pyrsistent:data", "@everest-testing_pip_deps//pytest:data", "@everest-testing_pip_deps//pytest_asyncio:data", "@everest-testing_pip_deps//python_dateutil:data", "@everest-testing_pip_deps//pyyaml:data", "@everest-testing_pip_deps//referencing:data", "@everest-testing_pip_deps//rpds_py:data", "@everest-testing_pip_deps//six:data", "@everest-testing_pip_deps//stringcase:data", "@everest-testing_pip_deps//tomli:data", "@everest-testing_pip_deps//websockets:data"]

_packages = [("everest-testing_pip_deps_pytest", "pytest==7.2.2"), ("everest-testing_pip_deps_pytest_asyncio", "pytest-asyncio==0.21.0"), ("everest-testing_pip_deps_python_dateutil", "python-dateutil==2.8.2"), ("everest-testing_pip_deps_paho_mqtt", "paho-mqtt==1.6.1"), ("everest-testing_pip_deps_pyftpdlib", "pyftpdlib==1.5.7"), ("everest-testing_pip_deps_ocpp", "ocpp==0.17.0"), ("everest-testing_pip_deps_websockets", "websockets==10.4"), ("everest-testing_pip_deps_pyopenssl", "pyOpenSSL==23.0.0"), ("everest-testing_pip_deps_cryptography", "cryptography==39.0.2"), ("everest-testing_pip_deps_packaging", "packaging==23.0"), ("everest-testing_pip_deps_pycparser", "pycparser==2.21"), ("everest-testing_pip_deps_attrs", "attrs>=22.2.0"), ("everest-testing_pip_deps_cffi", "cffi==1.15.1"), ("everest-testing_pip_deps_exceptiongroup", "exceptiongroup==1.1.1"), ("everest-testing_pip_deps_iniconfig", "iniconfig==2.0.0"), ("everest-testing_pip_deps_jsonschema", "jsonschema==4.20.0"), ("everest-testing_pip_deps_jsonschema_specifications", "jsonschema-specifications==2023.11.1"), ("everest-testing_pip_deps_pluggy", "pluggy==1.0.0"), ("everest-testing_pip_deps_pyrsistent", "pyrsistent==0.19.3"), ("everest-testing_pip_deps_pyyaml", "PyYAML==6.0.1"), ("everest-testing_pip_deps_markupsafe", "MarkupSafe==2.1.3"), ("everest-testing_pip_deps_six", "six==1.16.0"), ("everest-testing_pip_deps_tomli", "tomli==2.0.1"), ("everest-testing_pip_deps_jinja2", "Jinja2==3.1.2"), ("everest-testing_pip_deps_referencing", "referencing==0.31.0"), ("everest-testing_pip_deps_rpds_py", "rpds-py==0.13.1"), ("everest-testing_pip_deps_stringcase", "stringcase==1.2.0")]
